<template>
  <div class="">
    ...
    <table class="evaluate-table pb-30 year-table brakpage">
      ...
      <tr class="text-bold table-header">
        ...
        <td width="10%">检查方式</td>
        <td width="10%">检查单位</td>
        <td width="7%" style="text-align: center">检查结果</td>
        <td width="12%">整改建议</td>
      </tr>
      <!-- 一、机构管理 -->
      <template>
      ...
      <template>
        <tr class="part3 part-hash">
          ...
          <td
            class="bold"
            :class="{ 'warn-C': tableData.data_9.value === 'C' }"
          >
        ...
        <tr :class="{ 'warn-C': tableData.data_13.value === 'C' }">
          <td>13</td>
          <td class="bold">
            做好食品储存、运输、加工、制作的环节管理，做到：采购员不买腐烂变质的原料、库房保管员不收腐烂变质的原料、厨师不用腐烂变质的原料加工成品。不采购“三无”商品：无经营许可证、产品合格证、无卫生许可证，无厂名、厂址（店址）。
          </td>
          <td>1项不达标为不符合</td>
          <td>现场查看</td>
          <td>市场监管局</td>
      ...
      <template>
        ...
        <tr :class="{ 'warn-C': tableData.data_16.value === 'C' }">
          <td>16</td>
          <td class="bold">
           设立院内医疗机构或与医疗机构建立协作关系，院内医疗机构管理服务符合卫健局规定（证件、协议）。
          </td>
      ...
      <template>
        ...
        <tr :class="{ 'warn-C': tableData.data_24.value === 'C' }">
          <td>24</td>
          <td class="bold">
           工作人员熟悉《养老机构服务质量基本规范》和工作流程，严格开展考评，至少每半年一次，并及时改进工作，有考评记录和改进措施；对服务对象做到“七知道”（姓名、照料重点、爱好、疾病、家庭、治疗、心理）。
          </td>
          <td>
        ...
        <tr :class="{ 'warn-C': tableData.data_28.value === 'C' }">
          <td>28</td>
          <td class="bold">
            制定满意度测评制度，每半年测评1次，服务对象满意率不低于90%。
          </td>
      ...
      <template>
        <tr class="part7 part-hash">
          ...
          >
            建立在院服务对象档案管理库，要有生活档案和健康档案，包括入院服务对象健康评估、能力评估（入住评估、常规评估、即时评估）、入住协议（其中包括不得侵犯老年人肖像权、不得泄露老年人隐私等）、监护人和服务对象身份证明、监护人联系方式、在院记录等相关资料，请假、出院或死亡７天内档案必须入库。
          </td>
      ...
      <template>
        ...
        <tr :class="{ 'warn-C': tableData.data_32.value === 'C' }">
          <td>32</td>
          <td class="bold">
           配备至少１名持证上岗的兼职消防工作人员。有明确的消防责任人，对消防设施、特种设备进行日常维修保养，定期自检，指定有资质的机构对特种设备进行定期检验，有检查报告并备案。服务对象居室不能有火种、刀具、过期食品、药品等，每天检查1次。
          </td>
      ...
      <template>
        <tr class="part9 part-hash">
          ...
          >
            每天清洁居室卫生1次；室内物品摆放整齐有序，无障碍物；墙壁、门窗清洁无灰尘；桌面、地面无垃圾；每周进行1次卫生检查；每季度灭“四害”１次。
          </td>
