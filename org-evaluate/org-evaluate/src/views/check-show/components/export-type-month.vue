  ...
  <div class="">
    <table class="evaluate-table pb-30 month-table">
      ...
      <tr class="text-bold table-header">
        ...
        <td width="25%">检查细则</td>
        <td width="10%"> 检查方式</td>
        <td class="text-center" width="15%">检查结果</td>
        <td width="12%">整改建议</td>
      </tr>
      <!-- 一、住宿环境 -->
      <template>
      ...
      <template>
        <tr class="part2 part-hash">
          ...
          <td class="text-center" :class="{'warn-C': tableData.data_4.value === 'C'}">
      ...
      <template>
        ...
        <td class="text-center" :class="{'warn-C': tableData.data_8.value === 'C'}">
      ...
      <template>
        <tr class="part5 part-hash">
          ...
          <td class="text-center" :class="{'warn-C': tableData.data_13.value === 'C'}">
        ...
        <tr :class="{'warn-C': tableData.data_15.value === 'C'}">
          <td>15</td>
          <td class="bold">有工作人员职业道德准则或行为规范并落实。</td>
          <td></td>
          <td></td>
            <td class="text-center">
      ...
      <template>
        <tr class="part6 part-hash">
          ...
          <td :class="{'warn-C': tableData.data_17.value === 'C'}">未建立档案管理库不符合；档案资料每缺2项以上的为不符合。</td>
      ...
      <template>
        <tr class="part7 part-hash">
          ...
          <td class="text-center" :class="{'warn-C': tableData.data_18.value === 'C'}">
        ...
        <tr :class="{'warn-C': tableData.data_20.value === 'C'}">
          <td>20</td>
          <td class="bold">对消防设施、特种设备进行日常维修保养，定期自检。</td>
          <td>无相应服务、记录为不符合</td>
          <td>查看相关资料</td>
          <td class="text-center">
      ...
      <template>
        <tr class="part9 part-hash" >
          ...
          <td :class="{'warn-C': tableData.data_28.value === 'C'}">查看每周食谱更新情况、会议记录、整改记录，现场询问3保老人</td>
         <td class="text-center" :class="{'warn-C': tableData.data_28.value === 'C'}">
      ...
      <template>
        <tr class="part10 part-hash">
          ...
          <td :class="{'warn-C': tableData.data_29.value === 'C'}">查看活动图文、反馈记录、视频资 料；现场询问3名 以上老人</td>
        ...
        <tr :class="{'warn-C': tableData.data_30.value === 'C'}">
          ...
          <td>查看活动图文、反馈记录、视频资 料；现场询问3名 以上老人</td>
         <td class="text-center">
