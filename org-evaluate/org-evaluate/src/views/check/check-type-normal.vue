        ...
        <el-menu :default-active="activeHash" @select="selectHash">
          ...
          <el-submenu index="1-3">
            ...
            <el-menu-item-group>
              ...
              <el-menu-item index="27">康复服务</el-menu-item>
            </el-menu-item-group>
          </el-submenu>
        </el-menu>
      </div>
    ...
    <div class="wrap">
      <div class="center-wrap mt-16">
        <div class="center">
          ...
          <table class="evaluate-table org-title-content normal-table">
          ...
          <div class="table-wrap" @scroll="scrollEvent">
            <table class="evaluate-table table-body normal-table">
              <tbody>
                <!-- 1基本要求 -->
                  ...
                  <template>
                    ...
                    <template v-if="defer(4)">
                      <tr class="part4 part-hash">
                        ...
                        <td class="bold" :class="{'warn-C': tableData.data_34.value === 'C'}">
                ...
                <template class="table-container">
                  ...
                  <template v-if="defer(12)">
                    <tr class="part12 part-hash">
                      <td rowspan="69" class="td-top">3一般性服务内容</td>
                  ...
                  <template v-if="defer(14)">
                    <tr class="part14 part-hash">
                      ...
                      <td class="bold" :class="{'warn-C': tableData.data_159.value === 'C'}">
                        有提供休闲娱乐服务必要的设施设备和场地
                      </td>
                  ...
                  <template v-if="defer(20)">
                    <tr class="part20 part-hash">
                      ...
                      <td class="bold" :class="{'warn-C': tableData.data_186.value === 'C'}">
                        有必要的通信设备（至少有1部供老人使用的电话）
                      </td>
                  ...
                  <template v-if="defer(24)">
                    <tr class="part24 part-hash">
                      ...
                      <td class="bold" :class="{'warn-C': tableData.data_199.value === 'C'}">
                        保护老人隐私，不向他人谈论老人私人信息
                      </td>
                  ...
                  <template v-if="defer(26)">
                    <tr class="part26 part-hash">
                      ...
                      <td class="bold" :class="{'warn-C': tableData.data_204.value === 'C'}">
                    ...
                    <!--  3-16康复服务-->
                  <template v-if="defer(26)">
                    <tr class="part27 part-hash">
                      <td rowspan="4" class="td-top">3-16康复服务</td>
                      <td :class="{'warn-C': tableData.data_209.value === 'C'}">209</td>
                      <td class="bold" :class="{'warn-C': tableData.data_209.value === 'C'}">
                        提供康复医疗服务的人员取得康复医师或康复技师；提供非医疗康复服务的人员应经过培训，有操作规范，操作符合要求；
                      </td>
                      <td :class="{'warn-C': tableData.data_209.value === 'C'}">
                        如有，需要相对隔离的独立空间。设施设备需满足服务需求。
                      </td>
                      <td :class="{'warn-C': tableData.data_209.value === 'C'}">现场查看</td>
                      <td :class="{'warn-C': tableData.data_209.value === 'C'}">
                        <CheckedGrade
                          v-model="tableData.data_204.value"
                        ></CheckedGrade>
                    ...
                    <tr :class="{'warn-C': tableData.data_210.value === 'C'}">
                      <td>210</td>
                      <td>
                        医护人员做好症状的评估与观察，确定治疗原则，制订护理要点，提供相应医护服务。
                      </td>
                    ...
                    <tr :class="{'warn-C': tableData.data_211.value === 'C'}">
                      <td>211</td>
                      <td>
                        护理员做好环境、床单位管理，提供老年人所需的照料服务，使用轮椅、平车等辅助用具，做好评估与观察。
                      </td>
                      ...
                      <td>
                        <CheckedGrade
                          v-model="tableData.data_211.value"
                        ></CheckedGrade>
                      </td>
                      <td>
                        <CheckedText
                          v-model="tableData.data_211.text"
                        ></CheckedText>
                      </td>
                    </tr>
                    <tr :class="{'warn-C': tableData.data_212.value === 'C'}">
                      <td>212</td>
                      <td>
                        社会工作者或心理咨询师应做好心理社会评估与观察；对老年人和家属进行心理精神支持，关怀服务。应家属要求，协助处理老年人后事。
                      </td>
                      ...
                      <td>
                        <CheckedGrade
                          v-model="tableData.data_212.value"
                        ></CheckedGrade>
                      </td>
                      <td>
                        <CheckedText
                          v-model="tableData.data_212.text"
                        ></CheckedText>
                      </td>
                    </tr>
                  </template>
