                ...
                <template>
                  ...
                  <template>
                    ...
                    <template v-if="defer(3)">
                      ...
                      <tr
                        :class="{ 'warn-C': tableData.data_11.value === 'C' }"
                      >
                        <td>11</td>
                        <td>
                      ...
                      <tr
                        :class="{ 'warn-C': tableData.data_12.value === 'C' }"
                      >
                        <td>12</td>
                      ...
                      <tr
                        :class="{ 'warn-C': tableData.data_13.value === 'C' }"
                      >
                        <td>13</td>
                        <td>
                      ...
                      <tr
                        :class="{ 'warn-C': tableData.data_14.value === 'C' }"
                      >
                        <td>14</td>
                        <td>
                      ...
                      <tr
                        :class="{ 'warn-C': tableData.data_15.value === 'C' }"
                      >
                        <td>15</td>
                        <td>
                      ...
                      <tr
                        :class="{ 'warn-C': tableData.data_16.value === 'C' }"
                      >
                        <td>16</td>
                        <td class="bold">
                          老年人能接触到的各种设备无尖角凸出部分
                      ...
                      <tr
                        :class="{ 'warn-C': tableData.data_17.value === 'C' }"
                      >
                        <td>17</td>
                      ...
                      <tr
                        :class="{ 'warn-C': tableData.data_18.value === 'C' }"
                      >
                        <td>18</td>
                        <td class="bold">
                      ...
                      <tr
                        :class="{ 'warn-C': tableData.data_19.value === 'C' }"
                      >
                        <td>19</td>
                        <td>
                      ...
                      <tr
                        :class="{ 'warn-C': tableData.data_20.value === 'C' }"
                      >
                        <td>20</td>
                        <td>
                      ...
                      <tr
                        :class="{ 'warn-C': tableData.data_21.value === 'C' }"
                      >
                        <td>21</td>
                        <td class="bold">
                      ...
                      <tr
                        :class="{ 'warn-C': tableData.data_22.value === 'C' }"
                      >
                        <td>22</td>
                        <td>
                      ...
                      <tr
                        :class="{ 'warn-C': tableData.data_23.value === 'C' }"
                      >
                        <td>23</td>
                        <td>
                      ...
                      <tr
                        :class="{ 'warn-C': tableData.data_24.value === 'C' }"
                      >
                        <td>24</td>
                        <td>
                      ...
                      <tr
                        :class="{ 'warn-C': tableData.data_25.value === 'C' }"
                      >
                        <td>25</td>
                        <td>
                      ...
                      <tr
                        :class="{ 'warn-C': tableData.data_26.value === 'C' }"
                      >
                        <td>26</td>
                        <td>
                      ...
                      <tr
                        :class="{ 'warn-C': tableData.data_27.value === 'C' }"
                      >
                        <td>27</td>
                        <td>
                      ...
                      <tr
                        :class="{ 'warn-C': tableData.data_28.value === 'C' }"
                      >
                        <td>28</td>
                        <td>
                      ...
                      <tr
                        :class="{ 'warn-C': tableData.data_29.value === 'C' }"
                      >
                        <td>29</td>
                        <td class="bold">
                      ...
                      <tr
                        :class="{ 'warn-C': tableData.data_30.value === 'C' }"
                      >
                        <td>30</td>
                        <td>
                      ...
                      <tr
                        :class="{ 'warn-C': tableData.data_31.value === 'C' }"
                      >
                        <td>31</td>
                        <td class="bold">
                      ...
                      <tr
                        :class="{ 'warn-C': tableData.data_32.value === 'C' }"
                      >
                        <td>32</td>
                        <td>
                      ...
                      <tr
                        :class="{ 'warn-C': tableData.data_33.value === 'C' }"
                      >
                        <td>33</td>
                    ...
                    <template v-if="defer(4)">
                      ...
                      <tr
                        :class="{ 'warn-C': tableData.data_35.value === 'C' }"
                      >
                        <td>35</td>
                        <td>
                      ...
                      <tr
                        :class="{ 'warn-C': tableData.data_36.value === 'C' }"
                      >
                        <td>36</td>
                        <td class="bold">
                      ...
                      <tr
                        :class="{ 'warn-C': tableData.data_37.value === 'C' }"
                      >
                        <td>37</td>
                        <td>
                      ...
                      <tr
                        :class="{ 'warn-C': tableData.data_38.value === 'C' }"
                      >
                        <td>38</td>
                        <td>
                      ...
                      <tr
                        :class="{ 'warn-C': tableData.data_39.value === 'C' }"
                      >
                        <td>39</td>
                        <td>
                      ...
                      <tr
                        :class="{ 'warn-C': tableData.data_40.value === 'C' }"
                      >
                        <td>40</td>
                        <td>
                      ...
                      <tr
                        :class="{ 'warn-C': tableData.data_41.value === 'C' }"
                      >
                        <td>41</td>
                        <td class="bold">
                    ...
                    <template v-if="defer(5)">
                      ...
                      <tr
                        :class="{ 'warn-C': tableData.data_43.value === 'C' }"
                      >
                        <td>43</td>
                        <td class="bold">
                      ...
                      <tr
                        :class="{ 'warn-C': tableData.data_44.value === 'C' }"
                      >
                        <td>44</td>
                        <td class="bold">
                      ...
                      <tr
                        :class="{ 'warn-C': tableData.data_45.value === 'C' }"
                      >
                        <td>45</td>
                      ...
                      <tr
                        :class="{ 'warn-C': tableData.data_46.value === 'C' }"
                      >
                        <td>46</td>
                        <td class="bold">
                      ...
                      <tr
                        :class="{ 'warn-C': tableData.data_47.value === 'C' }"
                      >
                        <td>47</td>
                      ...
                      <tr
                        :class="{ 'warn-C': tableData.data_48.value === 'C' }"
                      >
                        <td>48</td>
                        <td>
                      ...
                      <tr
                        :class="{ 'warn-C': tableData.data_49.value === 'C' }"
                      >
                        <td>49</td>
                        <td>
                      ...
                      <tr
                        :class="{ 'warn-C': tableData.data_50.value === 'C' }"
                      >
                        <td>50</td>
                        <td>
                      ...
                      <tr
                        :class="{ 'warn-C': tableData.data_51.value === 'C' }"
                      >
                        <td>51</td>
                        <td class="bold">
                      ...
                      <tr
                        :class="{ 'warn-C': tableData.data_52.value === 'C' }"
                      >
                        <td>52</td>
                        <td class="bold">
                      ...
                      <tr
                        :class="{ 'warn-C': tableData.data_53.value === 'C' }"
                      >
                        <td>53</td>
                        <td>
                      ...
                      <tr
                        :class="{ 'warn-C': tableData.data_54.value === 'C' }"
                      >
                        <td>54</td>
                        <td>
                      ...
                      <tr
                        :class="{ 'warn-C': tableData.data_55.value === 'C' }"
                      >
                        <td>55</td>
                        <td>
                      ...
                      <tr
                        :class="{ 'warn-C': tableData.data_56.value === 'C' }"
                      >
                        <td>56</td>
                        <td>
                      ...
                      <tr
                        :class="{ 'warn-C': tableData.data_57.value === 'C' }"
                      >
                        <td>57</td>
                        <td>
                      ...
                      <tr
                        :class="{ 'warn-C': tableData.data_58.value === 'C' }"
                      >
                        <td>58</td>
                      ...
                      <tr
                        :class="{ 'warn-C': tableData.data_59.value === 'C' }"
                      >
                        <td>59</td>
                        <td class="bold">
                      ...
                      <tr
                        :class="{ 'warn-C': tableData.data_60.value === 'C' }"
                      >
                        <td>60</td>
                        <td class="bold">
                      ...
                      <tr
                        :class="{ 'warn-C': tableData.data_61.value === 'C' }"
                      >
                        <td>61</td>
                        <td>积极推进养老院标准化建设</td>
