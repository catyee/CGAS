                  ...
                  <div class="table-wrap">
                      ...
                      <table class="evaluate-table">
                          <tr>
                              ...
                              <td>
                                  <div class="text-box-group">
                                      <div class="text-box" v-for="(i,index) in evaluateData.A_1_1" :key="index">{{i}}</div>
                                  </div>
                              </td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                              ...
                              <td class="choices">
                                  <div class="choice-text">1接受服务前初评</div>
                                  <div class="choice-text">2接受服务后的常规评估</div>
                                  <div class="choice-text">3状况发生变化后的即时评估</div>
                                  <div class="choice-text">4因评估结果有疑问进行的复评</div>
                                  <div class="right text-box">38</div>
                              </td>
                          </tr>
                      </table>
                  </div>
                  ...
                  <div class="table-wrap">
                      ...
                      <table class="evaluate-table">
                          ...
                          <tr>
                              ...
                              <td>
                                  <div class="choices">
                                      <div class="choice-text">1男</div>
                                      <div class="choice-text">2女</div>
                          ...
                          <tr>
                              ...
                              <td>
                                  <div class="choices">
                                      <div class="choice-text">1汉族</div>
                                      <div class="choice-text" style="padding-right: 0;">2少数民族</div>
                                      <div class="text-undeline">白族</div>
                                      <div class="right text-box">2</div>
                                  </div>
                              </td>
                          </tr>
                          <tr>
                              ...
                              <td>
                                  <div class="choices">
                                      <div class="choice-text">1文盲</div>
                                      <div class="choice-text">2小学</div>
                                      <div class="choice-text">3初中</div>
                                      <div class="choice-text">4高中/技校/中专</div>
                                      <div class="choice-text">5大学专科及以上</div>
                                      <div class="choice-text">6不详</div>
                                      <div class="right text-box">2</div>
                                  </div>
                              </td>
                          </tr>
                          <tr>
                              ...
                              <td>
                                  <div class="choices">
                                      <div class="choice-text">0无</div>
                                      <div class="choice-text" style="padding-right: 0;">1有</div>
                                      <div class="text-undeline">道教</div>
                                      <div class="right text-box">2</div>
                                  </div>
                              </td>
                          </tr>
                          <tr>
                              ...
                              <td>
                                  <div class="choices">
                                      <div class="choice-text">1未婚</div>
                                      <div class="choice-text">2已婚</div>
                                      <div class="choice-text">3丧偶</div>
                                      <div class="choice-text">4离婚</div>
                                      <div class="choice-text">5未说明的婚姻状况</div>
                                      <div class="right text-box">2</div>
                                  </div>
                              </td>
                          </tr>
                          <tr>
                              ...
                              <td>
                                  <div class="choices">
                                      <div class="choice-text">1独居</div>
                                      <div class="choice-text">2与配偶/伴侣居住</div>
                                      <div class="choice-text">3与子女居住</div>
                                      <div class="choice-text">4与父母居住</div>
                                      <div class="choice-text">5与兄弟姐妹居住</div>
                                      <div class="choice-text">6与其他亲属居住</div>
                                      <div class="choice-text">7与非亲属关系的人居住</div>
                                      <div class="right text-box">2</div>
                                  </div>
                              </td>
                          </tr>
                          <tr>
                              ...
                              <td>
                                  <div class="choices">
                                      <div class="choice-text">1城镇职工基本医疗保险</div>
                                      <div class="choice-text">2城镇居民基本医疗保险</div>
                                      <div class="choice-text">3新型农村合作医疗</div>
                                      <div class="choice-text">4贫困求助</div>
                                      <div class="choice-text">5商业医疗保险</div>
                                      <div class="choice-text">6全公费</div>
                                      <div class="choice-text">7全自费</div>
                                      <div class="choice-text" style="text-align: right; padding-top:10px">8其他</div>
                                      <div class="text-undeline" >免费</div>
                          ...
                          <tr>
                              ...
                              <td>
                                  <div class="choices">
                                      <div class="choice-text">1退休金/养老金</div>
                                      <div class="choice-text">2子女补贴</div>
                                      <div class="choice-text">3亲友资助</div>
                                      <div class="choice-text" style="padding-right: 0;">4其他补贴</div>
                                      <div class="text-undeline" >免费</div>
                          ...
                          <tr>
                              ...
                              <td>
                                  <div class="choices">
                                      <div class="choice-text">0无</div>
                                      <div class="choice-text">1轻度</div>
                                      <div class="choice-text">2中度</div>
                                      <div class="choice-text">3重度</div>
                          ...
                          <tr>
                              ...
                              <td>
                                  <div class="choices">
                                      <div class="choice-text">0无</div>
                                      <div class="choice-text">1精神分裂症</div>
                                      <div class="choice-text">2双相情感障碍</div>
                                      <div class="choice-text">3偏执性精神障碍</div>
                                      <div class="choice-text">4分裂情感性障碍</div>
                                      <div class="choice-text">5癫痫所致精神障碍</div>
                                      <div class="choice-text">6精神发育迟滞伴发精神障碍</div>
                                      <div class="right text-box">
                                          3
                                      </div>
                                  </div>
                          ...
                          <tr>
                              <td class="question1">
                                  <span class="table-num">A.2.13.2</span>慢性疾病
                              </td>
                              <td>
                                  无
                              </td>
                          ...
                          <tr>
                              ...
                              <td>
                                  <div class="choices">
                                      <div class="choice-text">0无</div>
                                      <div class="choice-text">1发生过1次</div>
                                      <div class="choice-text">2发生过2次</div>
                                      <div class="choice-text">3发生过3次及以上</div>
                                      <div class="right text-box">
                                          3
                                      </div>
                                  </div>
                  ...
                  <div class="table-wrap">
                      ...
                      <table class="evaluate-table">
                          ...
                          <tr>
                              ...
                              <td>
                                  <div class="choices">
                                      <div class="choice-text">1配偶</div>
                                      <div class="choice-text">2子女</div>
                                      <div class="choice-text">3其他亲属</div>
                                      <div class="choice-text">4雇佣照顾者</div>
                                      <div class="choice-text" style="padding-right: 0;">5其他</div>
                                      <div class="text-undeline">其他</div>
                                      <div class="right text-box">2</div>
                                  </div>
                              </td>
                          </tr>
                  ...
                  <div class="table-wrap">
                      ...
                      <table class="evaluate-table">
                          <tr>
                              <td class="question" rowspan="3">
                                  <span class="table-num bold">B.1.1进食:</span>指用餐具将食物由容器送到口中、咀嚼、吞咽等过程
                              </td>
                              ...
                              <td>
                                  <div>10
                                      分，可独立进食（在合理的时间内独立进食准备好的食物）</div>
                              </td>
                          </tr>
                          <tr>
                              <td>
                                  <div>5 分，
                                      需部分帮助（进食过程中需要一定帮助，如协助把持餐具）</div>
                              </td>
                          </tr>
                          <tr>
                              <td>
                                  <div>0 分，
                                      需极大帮助或完全依赖他人，或有留置营养管</div>
                              </td>
                          </tr>
                      </table>
                      <!-- B1.2 -->
                      <table class="evaluate-table no-bt">
                          <tr>
                              ...
                              <td>
                                  <div>5 分， 准备好洗澡水后，可自己独立完成洗澡过程</div>
                              </td>
                          </tr>
                          <tr>
                              <td>
                                  <div>0 分， 在洗澡过程中需他人帮助</div>
                              </td>
                          </tr>
                      </table>
                      <!-- B1.3 -->
                      <table class="evaluate-table no-bt">
                          <tr>
                              <td class="question" rowspan="2">
                                  <span class="table-num bold">B.1.3 修饰：</span>指洗脸、刷牙、 梳头、刮脸等
                              </td>
                              <td class="question center" rowspan="2">
                                  <div class="text-box">2</div>
                                  分
                      ...
                      <table class="evaluate-table no-bt">
                          <tr>
                              <td class="question" rowspan="3">
                                  <span class="table-num bold">B.1.4 穿衣：</span>指穿脱衣服、系 扣、拉拉链、穿 脱鞋袜、系鞋带
                              </td>
                              <td class="question center" rowspan="3">
                                  <div class="text-box">2</div>
                                  分
                          ...
                          <tr>
                              <td>
                                  <div>5
                                      分，需部分帮助（能自己穿脱，但需他人帮助整理衣物、系扣/鞋带、拉拉链）</div>
                              </td>
                          </tr>
                          <tr>
                              <td>
                      ...
                      <table class="evaluate-table no-bt">
                          ...
                          <tr>
                              <td>
                                  <div>5 分， 偶尔失控（每周＜1 次），或需要他人提示</div>
                              </td>
                          </tr>
                          <tr>
                              <td>
                      ...
                      <table class="evaluate-table no-bt">
                          ...
                          <tr>
                              <td>
                                  <div>5 分， 偶尔失控（每天＜1 次，但每周＞1
                                      次），或需要他人提示</div>
                              </td>
                          </tr>
                          <tr>
                              <td>
                                  <div>0 分， 完全失控，或留置导尿管</div>
                              </td>
                          </tr>
                      </table>
                      <!-- B1.7 -->
                      <table class="evaluate-table no-bt">
                          ...
                          <tr>
                              <td>
                                  <div>5 分，
                                      需部分帮助（需他人搀扶去厕所、需他人帮忙冲水或整理衣裤等）</div>
                              </td>
                          </tr>
                          <tr>
                              <td>
                      ...
                      <table class="evaluate-table no-bt">
                          ...
                          <tr>
                              <td>
                                  <div>10 分，需部分帮助（需他人搀扶或使用拐杖）</div>
                              </td>
                          </tr>
                          <tr>
                              <td>
                                  <div>5 分，
                                      需极大帮助（较大程度上依赖他人搀扶和帮助）</div>
                              </td>
                          </tr>
                          <tr>
                              <td>
                  ...
                  <div class="table-wrap">
                      ...
                      <table class="evaluate-table no-bt">
                          ...
                          <tr>
                              <td>
                                  <div>1
                                      分，每月有几次身体攻击行为，或每周有几次语言攻击行为</div>
                              </td>
                          </tr>
                          <tr>
                              <td>
                                  <div>2
                                      分，每周有几次身体攻击行为，或每日有语言攻击行为</div>
                              </td>
                          </tr>
                      </table>
                      <!-- B2.3 -->
                      <table class="evaluate-table no-bt">
                          ...
                          <tr>
                              <td>
                                  <div>1 分，情绪低落、不爱说话、不爱梳洗、不爱活动</div>
                              </td>
                          </tr>
                          <tr>
                              <td>
                                  <div>2 分，有自杀念头或自杀行为</div>
                              </td>
                  ...
                  <div class="table-wrap">
                          ...
                          <tr>
                              <td>
                                  <div>2
                                      ...
                                      识清醒，醒后可简短回答提问，当刺激减弱后又很快进入睡眠状态</div>
                              </td>
                          </tr>
                          <tr>
                              <td>
                                  <div>3
                                      ...
                                      无反应（若评定为昏迷，直接评定为重度失能，可不进行以下项目的评估）</div>
                              </td>
                          </tr>
                      </table>
                      <!-- B3.2 -->
                      <table class="evaluate-table no-bt">
                          <tr>
                              ...
                              <td>
                                  <div>0 分，能看清书报上的标准字体</div>
                              </td>
                          </tr>
                          <tr>
                              <td>
                                  <div>1
                                      分，能看清楚大字体，但看不清书报上的标准字体</div>
                              </td>
                          </tr>
                          <tr>
                              <td>
                                  <div>
                                      2 分，视力有限，看不清报纸大标题，但能辨认物体</div>
                              </td>
                          </tr>
                          <tr>
                              <td>
                                  <div>3
                                      分，辨认物体有困难，但眼睛能跟随物体移动，只能看到光、颜色和形状</div>
                              </td>
                          </tr>
                          <tr>
                              <td>
                                  <div>4 分，没有视力，眼睛不能跟随物体移动</div>
                              </td>
                          </tr>
                      </table>
                      <!-- B3.3 -->
                      <table class="evaluate-table no-bt">
                          <tr>
                              ...
                              <td>
                                  <div>0
                                      分，可正常交谈，能听到电视、电话、门铃的声音</div>
                              </td>
                          </tr>
                          <tr>
                              <td>
                                  <div>1 分，在轻声说话或说话距离超过 2 米时听不清</div>
                              </td>
                          </tr>
                          <tr>
                              <td>
                                  <div>
                                      2
                                      分，正常交流有些困难，需在安静的环静或大声说话才能听到</div>
                              </td>
                          </tr>
                          <tr>
                              <td>
                                  <div>3 分，讲话者大声说话或说话很慢，才能部分听见</div>
                              </td>
                          </tr>
                          <tr>
                              <td>
                      ...
                      <table class="evaluate-table no-bt">
                          <tr>
                              ...
                              <td>
                                  <div>0 分，无困难，能与他人正常沟通和交流</div>
                              </td>
                          </tr>
                          <tr>
                              <td>
                                  <div>1
                                      分，能够表达自己的需要及理解别人的话，但需要增加时间或给予帮助</div>
                              </td>
                          </tr>
                          <tr>
                              <td>
                                  <div>
                                      2
                                      分，表达需要或理解有困难，需频繁重复或简化口头表达</div>
                              </td>
                          </tr>
                          <tr>
                              <td>
                                  <div>3 分，不能表达需要或理解他人的话</div>
                              </td>
                          </tr>
                      </table>
                      <!-- B3 -->
                  ...
                  <div class="table-wrap">
                      ...
                      <table class="evaluate-table">
                          ...
                          <tr>
                              <td>
                                  <div>1
                                      分，除个人生活自理外，能做家务，但欠好，家庭事务安排欠条</div>
                              </td>
                          </tr>
                          <tr>
                              <td>
                                  <div>2
                                      分，个人生活能自理；只有在他人帮助下才能做些家务，但质量不好</div>
                              </td>
                          </tr>
                          <tr>
                              <td>
                                  <div>3
                                      分，个人基本生活事务能自理（如饮食、二便），在督促下可洗漱</div>
                              </td>
                          </tr>
                          <tr>
                              <td>
                                  <div>4
                                      分，个人基本生活事务（如饮食、二便）需要部分帮助或完全依赖他人帮助</div>
                              </td>
                          </tr>
                      </table>
                      <!-- B4.2 -->
                      <table class="evaluate-table no-bt">
                          <tr>
                              ...
                              <td>
                                  <div>0
                                      分，原来熟练的脑力工作或体力技巧性工作可照常进行</div>
                              </td>
                          </tr>
                          <tr>
                              <td>
                                  <div>1
                                      分，原来熟练的脑力工作或体力技巧性工作能力有所下降</div>
                              </td>
                          </tr>
                          <tr>
                              <td>
                                  <div>
                                      2
                                      分，原来熟练的脑力工作或体力技巧性工作明显不如以往，部分遗忘</div>
                              </td>
                          </tr>
                          <tr>
                              <td>
                                  <div>3
                                      分，对熟练工作只有一些片段保留，技能全部遗忘</div>
                              </td>
                          </tr>
                          <tr>
                              <td>
                                  <div>4 分，对以往的知识或技能全部磨灭</div>
                              </td>
                          </tr>
                      </table>
                      <!-- B4.3 -->
                          ...
                          <tr>
                              ...
                              <td>
                                  <div>0
                                      ...
                                      可分辨陌生人的大致年龄和身份，可用适当称呼</div>
                              </td>
                          </tr>
                          <tr>
                              <td>
                                  <div>1
                                      分，只知家中亲密近亲的关系，不会分辨陌生人的大致年龄，不能称呼陌生人</div>
                              </td>
                          </tr>
                          <tr>
                              <td>
                                  <div>
                                      2
                                      分，只能称呼家中人，或只能照样称呼，不知其关系，不辨辈分</div>
                              </td>
                          </tr>
                          <tr>
                              <td>
                                  <div>3
                                      分，只认识常同住的亲人，可称呼子女或孙子女，可辨熟人和生人</div>
                              </td>
                          </tr>
                          <tr>
                              <td>
                                  <div>4 分，只认识保护人，不辨熟人和生人</div>
                              </td>
                          </tr>
                      </table>
                      <!-- B4.5 -->
                      <table class="evaluate-table no-bt">
                          <tr>
                              ...
                              <td>
                                  <div>0
                                      分，参与社会，在社会环境有一定的适应能力，待人接物恰当</div>
                              </td>
                          </tr>
                          <tr>
                              <td>
                  ...
                  <div class="table-wrap">
                          ...
                          <tr>
                              ...
                              <td>
                                  <div>
                                      ...
                                      <div class="text-box">2</div>级
                                  </div>
                              </td>
                              <td>
                                  <div class="c-td">
                                      <span class="table-num bold">C.1.2 精神状态：</span>
                                      <div class="text-box">7</div>级
                                  </div>
                              </td>
                          </tr>
                          <tr>
                      ...
                      <table class="evaluate-table no-bt">
                          <tr>
                              ...
                              <td>
                                  <div class="choices">
                                      <div class="choice-text">0 能力完好</div>
                                      <div class="choice-text">1 轻度失能</div>
                                      <div class="choice-text">2 中度失能</div>
                                      <div class="choice-text">3 重度失能</div>
                                      <div class="right text-box">
                                          2
                                      </div>
                                  </div>
                      ...
                      <table class="evaluate-table no-bt">
                          <tr>
                              ...
                              <td>
                                  <div class="choices">
                                      <div class="choice-text">0能力完好</div>
                                      <div class="choice-text">1轻度失能</div>
                                      <div class="choice-text">2中度失能</div>
                                      <div class="right text-box">
                                        0
                                      </div>
                                  </div>
                              ...
                              <td>
                                  <div class="sign-box">
                                      <div class="sign-input">
                                          <div>
                                              评估员签名:<div class="text-undeline">张三张三</div>、
                                              <div class="text-undeline">张三张三</div>
                                          </div>

                                      </div>
                                      <div class="sign-input" >
                                          <div>
                                          日期:<div class="text-undeline">2020</div>年
                                          <div class="text-undeline">12</div>月
                                          <div class="text-undeline">12</div>日
                                      </div>
                                      </div>
                                  </div>
                                  <div class="sign-box">
                                      <div class="sign-input">
                                          <div>信息提供者签名:<div class="text-undeline">张三张三</div></div>
