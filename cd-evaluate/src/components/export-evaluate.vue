            ...
            <tr>
              ...
              <td>
                <div class="choices">
                  ...
                  <div class="choice-text" style="padding-right: 0">
                    2少数民族
                  </div>
            ...
            <tr>
              ...
              <td>
                <div class="choices">
                  ...
                  <div class="right text-box">3</div>
                </div>
              </td>
            </tr>
            <!-- 精神疾病 -->
      ...
      <div id="tab-B1" class="evaluate-tab hash-tab">
        ...
        <div class="table-wrap">
          ...
          <table class="evaluate-table">
            ...
            <tr>
              <td>
                <div>0 分， 需极大帮助或完全依赖他人，或有留置营养管</div>
              </td>
            </tr>
          </table>
          <!-- B1.2 -->
          ...
          <table class="evaluate-table no-bt">
            ...
            <tr>
              <td>
                <div>5 分， 需极大帮助（较大程度上依赖他人搀扶和帮助）</div>
              </td>
            </tr>
            <tr>
              <td>
          ...
          <table class="evaluate-table no-bt">
            <tr>
              ...
              <td>
                <div>10 分，可独立上下楼梯（连续上下 10-15 个台阶）</div>
              </td>
            </tr>
            <tr>
              <td>
      ...
      <div id="tab-B2" class="evaluate-tab hash-tab">
        <div class="table-wrap">
          ...
          <table class="evaluate-table no-bt">
            ...
            <tr>
              <td>
                <div>2 分，每周有几次身体攻击行为，或每日有语言攻击行为</div>
              </td>
            </tr>
          </table>
          <!-- B2.3 -->
      ...
      <div id="tab-B3" class="evaluate-tab hash-tab">
        <div class="table-wrap">
          ...
          <table class="evaluate-table no-bt">
            ...
            <tr>
              <td>
                <div>1 分，能看清楚大字体，但看不清书报上的标准字体</div>
              </td>
            </tr>
            <tr>
              <td>
                <div>2 分，视力有限，看不清报纸大标题，但能辨认物体</div>
              </td>
            </tr>
            <tr>
              <td>
          ...
          <table class="evaluate-table no-bt">
            <tr>
              ...
              <td>
                <div>0 分，可正常交谈，能听到电视、电话、门铃的声音</div>
              </td>
            </tr>
            <tr>
              <td>
          ...
          <table class="evaluate-table no-bt">
            ...
            <tr>
              <td>
                <div>2 分，表达需要或理解有困难，需频繁重复或简化口头表达</div>
              </td>
            </tr>
            <tr>
              <td>
        ...
        <div class="table-wrap">
          ...
          <table class="evaluate-table no-bt">
            <tr>
              ...
              <td>
                <div>0 分，原来熟练的脑力工作或体力技巧性工作可照常进行</div>
              </td>
            </tr>
            <tr>
              <td>
                <div>1 分，原来熟练的脑力工作或体力技巧性工作能力有所下降</div>
              </td>
            </tr>
            <tr>
              <td>
            ...
            <tr>
              <td>
                <div>3 分，对熟练工作只有一些片段保留，技能全部遗忘</div>
              </td>
            </tr>
            <tr>
              <td>
          ...
          <table class="evaluate-table no-bt">
            ...
            <tr>
              <td>
                <div>3 分，勉强可与人交往，谈吐内容不清楚，表情不恰当</div>
              </td>
            </tr>
            <tr>
              <td>
            ...
            <tr>
              ...
              <td>
                <div class="choices">
                  ...
                  <div class="right text-box">0</div>
                </div>
              </td>
            </tr>
          </table>
              ...
              <td>
                <div class="sign-box">
                  ...
                  <div class="sign-input">
                    <div>
                      日期:
                      <div class="text-undeline">2020</div>
                      年
                      <div class="text-undeline">12</div>
                      月
                      <div class="text-undeline">12</div>
                      日
                    </div>
