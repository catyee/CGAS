  ...
  data () {
    return {
      ...
      evaluateData: {
        ...
        A_2_1: '测试', // 姓名
        A_2_2: 2, // 性别
        A_2_3: '2020-12-12', // 出生日期
        A_2_4: '370181199208176522', // 身份证号
        A_2_5: '123456789', // 社保卡号
        A_2_6: {
          value: 2,
          text: '白族'
        }, // 民族
